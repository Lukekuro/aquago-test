		...
		<div class="swiper swiper-product-image" data-columns="<?php echo esc_attr( $columns ); ?>">
			<div class="swiper-wrapper">
				<?php if ( $post_thumbnail_id ) : ?>
					<div class="swiper-slide" data-image-id="<?php echo esc_attr( $post_thumbnail_id ); ?>">
						<a class="c-image" data-fancybox="gallery" href="<?php echo esc_url( wp_get_attachment_url( $post_thumbnail_id ) ); ?>">
							<?php echo wp_get_attachment_image( $post_thumbnail_id, 'large', false, [ 'class' => 'img-cover' ] ); ?>
						</a>
					</div>
				<?php endif; ?>
				<?php foreach ( $attachment_ids as $attachment_id ) : ?>
					<div class="swiper-slide" data-image-id="<?php echo esc_attr( $attachment_id ); ?>">
						<a class="c-image" data-fancybox="gallery" href="<?php echo esc_url( wp_get_attachment_url( $attachment_id ) ); ?>">
