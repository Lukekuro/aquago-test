		...
		<div class="top-header">
			<div class="top-header-left">
				...
				<?php if ( have_rows( 'top_list_header', 'option' ) ) : ?>
					<?php while ( have_rows( 'top_list_header', 'option' ) ) : the_row(); ?>
			...
			<div class="top-header-right">
				...
				<?php if ( $contact_email ) : ?>
					<a href="mailto:<?php echo esc_html( $contact_email ); ?>" class="contact_email visible-md-up" rel="phone">
		...
		<div class="middle-header">
			...
			<div class="middle-header-right">
				<nav class="main-nav">
					...
					<?php if ( $number_phone ) : ?>
						<a href="tel:<?php echo itm_phone_cleaner( $number_phone ); ?>" class="number_phone hidden-md-up" rel="phone">
