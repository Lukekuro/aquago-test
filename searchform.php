...
?>
 ...
 <form role="search" method="get" class="woocommerce-product-search search-form" action="<?php echo esc_url( home_url( '/' ) ); ?>">
   ...
   <input type="search" id="woocommerce-product-search-field-<?php echo isset( $index ) ? absint( $index ) : 0; ?>" class="search-field search-form__input" placeholder="<?php echo esc_attr__( 'Czego szukasz?', 'aquago' ); ?>" value="<?php echo get_search_query(); ?>" name="s" />
